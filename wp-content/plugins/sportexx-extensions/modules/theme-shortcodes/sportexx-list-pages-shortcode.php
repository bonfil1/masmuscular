...
add_shortcode( 'sportexx-child-pages', 		array( 'Sportexx_List_Pages_Shortcode', 'shortcode_list_pages' ) );
add_shortcode( 'sportexx-sibling-pages', 	array( 'Sportexx_List_Pages_Shortcode', 'shortcode_list_pages' ) );
add_shortcode( 'sportexx-list-pages', 		array( 'Sportexx_List_Pages_Shortcode', 'shortcode_list_pages' ) );

add_filter( 'sportexx_list_pages_shortcode_excerpt', array( 'Sportexx_List_Pages_Shortcode', 'excerpt_filter' ) );

class Sportexx_List_Pages_Shortcode {
	...
	static function shortcode_list_pages( $atts, $content, $tag ) {
		...
		// Child Pages
		$child_of = 0;
		if ( $tag == 'sportexx-child-pages' ) {
			$child_of = $post->ID;
		}
		if ( $tag == 'sportexx-sibling-pages' ) {
		...
		$defaults = array(
			...
			'meta_key'             => '',
			'meta_value'           => '',
			'walker'               => new Sportexx_List_Pages_Shortcode_Walker_Page,
			'post_type'            => 'page',
			'offset'               => '',
			'post_status'          => 'publish',
 ...
 */
class Sportexx_List_Pages_Shortcode_Walker_Page extends Walker_Page {
	...
	function start_el( &$output, $page, $depth = 0, $args = array(), $current_page = 0 ) {
		...
		if ( '' === $page->post_title ) {
			$page->post_title = sprintf( __( '#%d (no title)', 'sportexx-extensions' ), $page->ID );
		}
...
global $Sportexx_List_Pages_Shortcode;
$Sportexx_List_Pages_Shortcode = new Sportexx_List_Pages_Shortcode();