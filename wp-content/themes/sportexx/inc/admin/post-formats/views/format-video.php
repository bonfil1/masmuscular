<div class="cf-elm-block" id="cfpf-format-video-fields" style="display: none;">
	<!-- <label for="cfpf-format-video-embed"><?php _e('Video URL (oEmbed) or Embed Code', 'sportexx'); ?></label>
	...
	<div id="postbox-container-postformat" class="postbox-container">
		<!-- <div class="meta-box-sortables ui-sortable"> -->
			...
			<div id="meta-box-postformat-video" class="postbox" style="display: block;">
				...
				<h3><span><?php _e('Video Options', 'sportexx'); ?></span></h3>
				
				<div class="inside">

					<p style="padding:10px 0 0 0;"><?php _e('For HTML5 video support and Flash fallback please include an M4V file. Include an OGV file optionally to increase cross browser support.', 'sportexx'); ?></p>
							...
							<!-- <tr>
								<th>
									<label for="postformat_video_height">
										<strong><?php _e('Video Height', 'sportexx'); ?></strong>
										<span><?php _e('The video height (e.g. 500).', 'sportexx'); ?></span>
									</label>
								</th>
								<td>
							...
							<tr>
								<th>
									<label for="postformat_video_m4v">
										<strong><?php _e('M4V File URL', 'sportexx'); ?></strong>
										<span><?php _e('The URL to the .m4v video file', 'sportexx'); ?></span>
									</label>
								</th>
								<td>
							...
							<tr>
								<th>
									<label for="postformat_video_ogv">
										<strong><?php _e('OGV File URL', 'sportexx'); ?></strong>
										<span><?php _e('The URL to the .ogv video file', 'sportexx'); ?></span>
									</label>
								</th>
								<td>
							...
							<tr>
								<th>
									<label for="postformat_video_webm">
										<strong><?php _e('WEBM File URL', 'sportexx'); ?></strong>
										<span><?php _e('The URL to the .webm video file', 'sportexx'); ?></span>
									</label>
								</th>
								<td>
							...
							<tr>
								<th>
									<label for="postformat_video_poster">
										<strong><?php _e('Video Poster', 'sportexx'); ?></strong>
										<span><?php _e('A preivew image.', 'sportexx'); ?></span>
									</label>
								</th>
								<td>
							...
							<tr style="border-top: 1px solid #eeeeee;">
								<th>
									<label for="postformat_video_embed">
										<strong><?php _e('Embedded Code', 'sportexx'); ?></strong>
										<span><?php _e('If not using self hosted video you can include embeded code here.', 'sportexx'); ?></span>
									</label>
								</th>
								<td>
