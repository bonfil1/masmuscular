<div class="cf-elm-block" id="cfpf-format-audio-fields" style="display: none;">
	<!-- <label for="cfpf-format-audio-embed"><?php _e('Audio URL (oEmbed) or Embed Code', 'sportexx'); ?></label>
	...
	<div id="postbox-container-postformat" class="postbox-container">
		<!-- <div class="meta-box-sortables ui-sortable"> -->
			...
			<div id="meta-box-postformat-video" class="postbox" style="display: block;">
				...
				<h3><span><?php _e('Audio Options', 'sportexx'); ?></span></h3>
				
				<div class="inside">

					<p style="padding:10px 0 0 0;"><?php _e('Enter the paths to your audio files in the fields below', 'sportexx'); ?></p>
							...
							<tr>
								<th>
									<label for="postformat_audio_mp3">
										<strong><?php _e('MP3 File URL', 'sportexx'); ?></strong>
										<span><?php _e('URL to an .mp3 file', 'sportexx'); ?></span>
									</label>
								</th>
								<td>
							...
							<tr>
								<th>
									<label for="postformat_audio_ogg">
										<strong><?php _e('OGA File URL', 'sportexx'); ?></strong>
										<span><?php _e('URL to an .oga or .ogg file', 'sportexx'); ?></span>
									</label>
								</th>
								<td>
							...
							<tr>
								<th>
									<label for="postformat_audio_embedded">
										<strong><?php _e('Embedded Audio', 'sportexx'); ?></strong>
										<span><?php _e('Add embedded audio formats.', 'sportexx'); ?></span>
									</label>
								</th>
								<td>
