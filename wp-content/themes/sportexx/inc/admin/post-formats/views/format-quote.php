<div class="cf-elm-block" id="cfpf-format-quote-fields" style="display: none;">
	<!-- <div class="cf-elm-block">
		<label for="cfpf-format-quote-source-name"><?php _e('Source Name', 'sportexx'); ?></label>
	...
	<div class="cf-elm-block">
		<label for="cfpf-format-quote-source-url"><?php _e('Source URL', 'sportexx'); ?></label>
	...
	<div id="postbox-container-postformat" class="postbox-container">
		<!-- <div class="meta-box-sortables ui-sortable"> -->
			...
			<div id="meta-box-postformat-video" class="postbox" style="display: block;">
				...
				<h3><span><?php _e('Quote', 'sportexx'); ?></span></h3>
							...
							<tr>
								<th>
									<label for="postformat_quote_text">
										<strong><?php _e('Quote', 'sportexx'); ?></strong>
										<span><?php _e('The text being quoted.', 'sportexx'); ?></span>
									</label>
								</th>
								<td>
							...
							<tr>
								<th>
									<label for="postformat_quote_source">
										<strong><?php _e('Source Name', 'sportexx'); ?></strong>
										<span><?php _e('The person being cited.', 'sportexx'); ?></span>
									</label>
								</th>
								<td>
